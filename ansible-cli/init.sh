...
docker run --name debian1 --hostname debian1 -d -v /etc/localtime:/etc/localtime:ro 11459/debian-ansible:latest
box "Create new container : Ubuntu" "green" "blue"
docker run --name ubuntu1 --hostname ubuntu1 -d -v /etc/localtime:/etc/localtime:ro 11459/ubuntu-ansible:latest
box "Create new container : Centos" "green" "blue"
docker run --name centos1 --hostname centos1 -d -v /etc/localtime:/etc/localtime:ro 11459/centos-ansible:latest
